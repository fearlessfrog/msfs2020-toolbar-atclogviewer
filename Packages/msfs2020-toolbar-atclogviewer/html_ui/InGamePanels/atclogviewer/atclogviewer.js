const ALV_URL = "http://localhost:41716/";

class IngamePanelALVPanel extends TemplateElement {
    constructor() {
        super(...arguments);
    ...
    connectedCallback() {
        ...
        this.iframeElement = document.getElementById("ALVPanelIframe");
        ...
        if (this.ingameUi) {
            this.ingameUi.addEventListener("panelActive", (e) => {
                ...
                if (self.iframeElement) {
                    self.iframeElement.src = ALV_URL;
                }
            });
...
window.customElements.define("ingamepanel-alv", IngamePanelALVPanel);
checkAutoload();
